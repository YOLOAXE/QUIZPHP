<section class="page-section" id="Connection">
	<div class="container">
		<h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Quizz Connexion</h2>
		...
		<div class="row">
			<div class="col-lg-8 mx-auto">
				<?php
					echo form_open('StudentManager/studentConnectionQuizz', 'novalidate="novalidate"');
				?>
